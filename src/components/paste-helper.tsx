  ...
  return (
    ...
    >
      <DialogContent className="sm:max-w-lg">
        <DialogHeader>
          <DialogTitle>Paste a listing</DialogTitle>
          <DialogDescription>
            We only read public Open Graph title, description, and image — no
            NoBroker or Facebook scrape. Confirm the guess before it is saved.
          </DialogDescription>
        </DialogHeader>
        ...
        <DialogFooter>
          ...
          <Button onClick={confirm} disabled={!result}>
            Review in form
          </Button>
        </DialogFooter>
      </DialogContent>
